  ...
  <div id="home">
    ...
    <div v-if="!authState?.isAuthenticated">
      ...
      <p>
        ...
        <a href="https://github.com/okta/okta-vue">Okta Vue Library</a> to add
        the
        <a
      ...
      <p>
        ...
        returned to this application with an ID token and access token. These
        tokens will be stored in local storage and can be retrieved at a later
        time.
      </p>
      <button
        id="login-button"
